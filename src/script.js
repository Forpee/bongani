...
ScrollReveal().reveal('.earth, .t-img-2',{
    duration   : 600,
    delay: 350,
    distance   : '10px',
    easing     : 'ease-out',
  ...
  ScrollReveal().reveal('.l-tsm-header,.l-tsm-p, .ed-tech-text, .d-p, .tech-p', {
    duration   : 600,
    scale      : 1,
    delay: 350,
    distance   : '120px',
  ...
  ScrollReveal().reveal('.hat,.d-img, .t-img-1, .footer-img, .header-infographic',{
    duration   : 600,
    delay: 350,
    distance   : '120px',
    easing     : 'ease-out',
  ...
  ScrollReveal().reveal('.small-services-title, .big-services-title, .d-title, .d-subheading, .footer-p, .small-tech-title, .big-tech-title', {
    duration   : 600,
    scale      : 1,
    delay: 100,
    distance   : '30px',
